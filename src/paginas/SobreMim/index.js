    ...
    return (
        ...
        >
           ...
           <p className={styles.paragrafo}>
            ...
            posteriormente fazer uma aula experimental, o que me deixou completamente encantada. Na época, por incompatibilidade de horários, não consegui fazer o curso   
            ...
            projetos, tendo a liberdade de dar ideias, de dizer onde são minhas dificuldades, de aprender, de pesquisar e aplicar, de trabalhar
            ...
            <p className={styles.end}>  A bênção já existe. Basta clareza para acessá-la.🌟 </p>
        </PostModelo>
    )
}