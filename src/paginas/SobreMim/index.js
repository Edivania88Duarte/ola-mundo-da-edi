...
export default function SobreMim() {
    return (
        ...
        >
           ...
           <p className={styles.paragrafo}>
            Tenho formação em Direito, uma área que me ensinou muito sobre disciplina, trabalho colaborativo e análise crítica. 
            ...
            Atualmente, curso Análise e Desenvolvimento de Sistemas e atuo como estagiária de Desenvolvimento.
            </p>
            <p className={styles.paragrafo}>
            O primeiro contato com Tecnologia, se deu forma genuína, através de uma conversa com minha filha no começo de 2023.
            A forma como ela abordou o assunto me deixou super curiosa, então comecei a pesquisar e ainda sem entender, participei de um workshop de programação, no qual tive a oportunidade de
            fazer uma aula experimental, o que me deixou completamente encantada. Na época, por incompatibilidade de horários, não consegui fazer o curso   
            presencial, porém, na metade do ano encontrei um curso online, que viabilizou o início dos meus estudos e fometou, ainda mais, a vontade de ingressar na área.            
            </p>
            <p className={styles.paragrafo}>
            ...
            focada em aprender e realizar minha transição de carreira, pois visava muito, conseguir o tão sonhado home-office para ter mais tempo de qualidade com 
            ...
            projetos, tendo a liberdade de dar ideias, de dizer onde são minhas dificuldades, de aprender através dos treinamentos, de pesquisar e aplicar, de trabalhar
